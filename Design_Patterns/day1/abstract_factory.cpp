...
class Boing : public Airplane
{
public:
    string Operation() override
    {
        return " hello i am Boing flayyy , i from Armenia !!! ";
    }
};

class Il : public Airplane
{
public:
    string Operation() override
    {
        return " hello i am Il flayyyy , i from russia !!!  ";
    }
};

class Airplane_fabrica
{
public:
    Airplane *get_Airplane(string country)
    {
