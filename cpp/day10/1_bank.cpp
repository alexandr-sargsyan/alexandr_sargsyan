...
int main (int argc , char * argv[]){
   ...
   time_t now2 = time (0);
	...
	for (int i = 1; i <= amis; i++){
	   ...
	   cout << ctime(&(now += (30.4167)*24*60*60))  << " avelacac gumar = " << tarberutyun << endl;     // < 30.4167> - tiv@ ta mijin amsva orna
	   cout << ctime(&(now2 += (30.4167)*24*60*60))  << " mayr gumar = " << mayrgumar << endl ;         // bak@ tokos@ tama tarav ev amisav amsavchi hashvum
